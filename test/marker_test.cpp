...
TEST_CASE("BranchInstrumenter if-else compound", "[dcei][if]") {
...
TEST_CASE("BranchInstrumenter if with return", "[dcei][if][return]") {
    auto Code = R"code(int foo(int a){
        if (a > 0)
            return 1;
        return 0;
...
TEST_CASE("BranchInstrumenter nested if with return",
...
TEST_CASE("BranchInstrumenter for stmt with return", "[dcei][for][return]") {
...
TEST_CASE("BranchInstrumenter while stmt with return",
          "[dcei][while][return]") {
...
TEST_CASE("BranchInstrumenter do while stmt with return",
          "[dcei][do][return]") {
...
TEST_CASE("BranchInstrumenter switch", "[dcei][switch][return]") {
    auto Code = R"code(int foo(int a){
        switch(a){
        case 1:
            a = 2;
